        ...
        static async Task Main(string[] args)
        {
            ...
            while (true)
            {
                switch (Console.ReadLine()!.ToLower().Trim())
                {
                    ...
                    case "change":
                    {
                        Console.WriteLine(manager.GetMeetingsForChange());
                        if (manager.GetMeetingsForChange().Equals("У вас не заплонированы встречи"))
                            break;
                        Console.WriteLine(
                        ...
                        if (changeId == "back")
                            break;
                        if (!int.TryParse(changeId, out int change))
                        {
                            Console.WriteLine("Пожалуйста повторите операцию и введите число");
                            break;
                        }
                        ...
                        Console.WriteLine(manager.ChangeMeeting(Convert.ToInt32(changeId), s[0]!.Trim(),
                    ...
                    case "delete":
                        ...
                        if (deleteId == "back")
                            break;
                        if (!int.TryParse(deleteId, out int delete))
                        {
                            Console.WriteLine("Пожалуйста повторите операцию и введите число");
                            break;
                        }
                    ...
                    case "information":
                        Console.WriteLine(
                            "Для того чтобы посмотреть все расписание введите 'all' или введите день в следующем формате(1.01.2023). Если хотите вернуться назад то введите 'back'");
